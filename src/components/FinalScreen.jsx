...
export default function FinalScreen({ ...motionProps }) {
  ...
  const finalMessage =
    "Even miles apart, my Nancy babu❤️, you're all I think about.Every second without you feels incomplete😔. I miss your smile😊, your laugh😂, your voice🎶— everything, betu💕.You are my peace in this noisy world🌍, my safe place, my sweetest baccha🥰. No matter the distance, you’ll always live in my heart❤️. I can’t wait for the day I hold you tight in my arms🤗.Until then, just know… I miss you more than words can ever say, my Nancy betu🌙💕.";
  ...
  return (
    ...
    >
      <div className="max-w-4xl z-10">
        ...
        >
          <div>
            <img src="/gifs/us.gif" alt="us gif" className="w-48" />
          </div>
        </motion.div>
